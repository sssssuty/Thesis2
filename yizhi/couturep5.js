// function myFunction() {
//   var a = document.getElementById("favcolor1").value;
//   console.log(a);
// }
...
function setup() {
  var canvas = createCanvas(560, 560);
  canvas.parent('ca');
...
function draw() { 
  backgroundColor = document.getElementById("favcolor2").value;
  charColor = document.getElementById("favcolor1").value;
  // console.log(a);
  noStroke();
